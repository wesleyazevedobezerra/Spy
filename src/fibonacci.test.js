...
(async() =>{

    {
        ...
        const spy = sinon.spy(fibonacci, fibonacci.execute.name) //Spy vai analisar o comportamento dessa função
        ...
        console.log('callcount', spy.callCount) //Consigo ver quantas vezes a função vai ser chamada
